...
export default function Footer() {
    ...
    return (
        <div className="  w-full max-w-[500px] flex justify-center items-center ">
            <div className=" w-full pt-[7vmin] pb-[2.5vmin] sm:pt-[3vmin] sm:pb-[1vmin] flex justify-evenly items-center bg-footerBg">
                
                <Link href="/">
                    <div className="w-[13vmin] sm:w-[6vmin] aspect-[45/45] relative active:scale-90 transition-transform duration-200">
                ...
                {hasTickets ? <Link href="/games">
                    <div onClick={useTickets} className="w-[17vmin] sm:w-[9vmin] aspect-[45/45] relative active:scale-90 transition-transform duration-200">
                    ...
                    <div className="w-[17vmin] sm:w-[9vmin] aspect-[45/45] relative active:scale-90 transition-transform duration-200">
                        <p className=" absolute top-[-25%] left-1/2 -translate-x-1/2 font-bold text-white text-[1.2vmax] sm:text-[1.2vmin] text-center">Play</p>
                        <Image
                            src="/image/elr_game_off.png"
                            alt="meatIcon"
                            fill
                            style={{ objectFit: "cover" }}
                            priority
